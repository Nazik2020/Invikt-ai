...
const SkillDistributionMatrix = () => {
  return (
    <div className="lg:col-span-8 glass-card rounded-xl border border-outline-variant/15 overflow-hidden flex flex-col">
      <div className="p-8 border-b border-slate-200 dark:border-outline-variant/10 flex justify-between items-center">
        ...
        <div className="flex gap-2 items-center">
          ...
          <span className="text-xs text-slate-600 dark:text-on-surface-variant uppercase font-bold font-label">
            Mohamed
          </span>
          <span className="w-3 h-3 rounded-full bg-slate-50 dark:bg-surface-container-highest ml-4"></span>
          <span className="text-xs text-slate-600 dark:text-on-surface-variant uppercase font-bold font-label">
            Target
          </span>
        </div>
      ...
      <div className="p-8 flex-1 flex items-center justify-center min-h-[400px] relative">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 50% 50%, #cdbdff 0%, transparent 70%)",
          }}
        ></div>
        <div className="grid grid-cols-5 gap-4 w-full">
          ...
          <div className="aspect-square rounded-lg bg-slate-50 dark:bg-surface-container-highest border border-primary/40 flex items-center justify-center group cursor-help transition-all hover:scale-105">
