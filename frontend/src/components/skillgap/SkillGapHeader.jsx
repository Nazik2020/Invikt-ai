    ...
    <header className="mb-12 relative">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <h1 className="text-5xl lg:text-7xl font-headline font-extrabold tracking-tighter text-slate-900 dark:text-on-surface leading-[1.1]">
            Mohamed vs. <span className="text-gradient">ML Engineer</span>
          </h1>
          <p className="mt-4 text-slate-600 dark:text-on-surface-variant text-lg max-w-2xl leading-relaxed font-body">
            Precision audit of your technical architecture. We've identified
            critical voids in your neural engineering stack that separate you
            from the Elite 1%.
          </p>
        </div>
        <div className="flex gap-4">
          <div className="glass-card p-6 rounded-xl border border-outline-variant/15 text-center">
            ...
            <div className="text-[10px] uppercase font-bold text-slate-600 dark:text-on-surface-variant tracking-widest mt-1">
              Match Core
            </div>
          </div>
          <div className="glass-card p-6 rounded-xl border border-outline-variant/15 text-center">
