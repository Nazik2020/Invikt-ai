...
const ResumeScoreMeter = () => {
  return (
    <section className="col-span-12 lg:col-span-4">
      <div className="bg-slate-50 dark:bg-surface-container-highest rounded-xl p-8 h-full flex flex-col items-center justify-center relative overflow-hidden">
        ...
        <div className="relative w-48 h-48 mb-6">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <span className="font-headline text-6xl font-black text-slate-900 dark:text-on-surface">
              85
            </span>
            <span className="font-label text-xs uppercase tracking-tighter text-slate-600 dark:text-on-surface-variant mt-1">
              Resume Score
            </span>
          </div>
        </div>
        ...
        <div className="text-center">
          <p className="font-body text-slate-600 dark:text-on-surface-variant text-sm mb-4">
