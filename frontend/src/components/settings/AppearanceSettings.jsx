...
const AppearanceSettings = () => {
    ...
    return (
        <div>
            <div className="mb-10">
                <h1 className="text-3xl font-bold text-white mb-2 tracking-tight">Appearance</h1>
                <p className="text-[15px] text-white/60">Customize how Invikt AI looks on your device.</p>
            </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <button 
                        ...
                        className={`relative flex flex-col items-center rounded-2xl border transition-all ${
                            theme === 'dark' ? 'border-[#ab8ff4] bg-[#ab8ff4]/5' : 'border-white/10 bg-[#17181c] hover:border-white/20'
                        }`}
                    >
                        ...
                        <div className="py-4 border-t border-white/5 w-full text-center text-sm font-medium">Dark</div>
                        {theme === 'dark' && (
                    ...
                    <button 
                        ...
                        className={`relative flex flex-col items-center rounded-2xl border transition-all ${
                            theme === 'light' ? 'border-[#ab8ff4] bg-[#ab8ff4]/5' : 'border-white/10 bg-[#17181c] hover:border-white/20'
                        }`}
                    >
                        <div className="p-4 w-full aspect-video flex items-center justify-center">
                        ...
                        <div className="py-4 border-t border-white/5 w-full text-center text-sm font-medium">Light</div>
                        {theme === 'light' && (
                            <div className="absolute top-3 right-3 w-5 h-5 rounded-full bg-[#ab8ff4] text-white flex items-center justify-center shadow-lg shadow-[#ab8ff4]/30">
                                <span className="material-symbols-outlined text-[12px] font-bold">check</span>
                            </div>
                    ...
                    <button 
                        ...
                        className={`relative flex flex-col items-center rounded-2xl border transition-all ${
                            theme === 'system' ? 'border-[#ab8ff4] bg-[#ab8ff4]/5' : 'border-white/10 bg-[#17181c] hover:border-white/20'
                        }`}
                    >
                        <div className="p-4 w-full aspect-video flex items-center justify-center">
                            <div className="w-full h-full rounded-lg border border-white/5 flex overflow-hidden">
                                <div className="w-1/2 h-full bg-[#0c0d11]"></div>
                                <div className="w-1/2 h-full bg-white"></div>
                            </div>
                        </div>
                        <div className="py-4 border-t border-white/5 w-full text-center text-sm font-medium">System</div>
                        {theme === 'system' && (
                            <div className="absolute top-3 right-3 w-5 h-5 rounded-full bg-[#ab8ff4] text-white flex items-center justify-center shadow-lg shadow-[#ab8ff4]/30">
                                <span className="material-symbols-outlined text-[12px] font-bold">check</span>
                            </div>
                    ...
                    {accentColors.map((color) => (
                        <button
                            ...
                            className={`relative w-10 h-10 rounded-full flex items-center justify-center transition-transform hover:scale-110 ${
                                accentColor === color.id ? 'ring-2 ring-white/20 ring-offset-4 ring-offset-[#0c0d11]' : ''
                            }`}
                            style={{ backgroundColor: color.hex }}
                        >
                            {accentColor === color.id && (
                                <span className="material-symbols-outlined text-[18px] text-white/90 drop-shadow-sm">
                                    check
                                </span>
                            )}
                        </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
                        ...
                        {[
                            ...
                            <button
                                ...
                                className={`flex items-center gap-4 p-4 rounded-xl border transition-all ${
                                    ...
                                    ? 'border-[#ab8ff4]/30 bg-[#ab8ff4]/5' 
                                    : 'border-white/5 bg-[#17181c] hover:border-white/10'
                                }`}
                            >
                ...
                <div>
                    ...
                    <div className="flex p-1 bg-[#1c1d22] border border-white/5 rounded-xl mb-10">
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex items-center justify-between">
                            <span className="text-sm font-medium text-white/90">Reduce Motion</span>
                            <button 
                                onClick={() => setReduceMotion(!reduceMotion)}
                                className={`w-11 h-6 rounded-full flex items-center p-1 transition-colors ${
                                    reduceMotion ? 'bg-[#ab8ff4]' : 'bg-white/10'
                                }`}
                            >
                        ...
                        <div className="flex items-center justify-between">
                            <span className="text-sm font-medium text-white/90">Compact Cards</span>
                            <button 
                                onClick={() => setCompactCards(!compactCards)}
                                className={`w-11 h-6 rounded-full flex items-center p-1 transition-colors ${
                                    compactCards ? 'bg-[#ab8ff4]' : 'bg-white/10'
                                }`}
                            >
                                <div className={`w-4 h-4 rounded-full bg-white shadow-sm transition-transform ${
            ...
            {/* Info Banner */}
            <div className="bg-[#17181c] border border-white/5 rounded-2xl p-6 flex gap-4 mt-8 relative overflow-hidden">
                <div className="absolute left-0 top-0 w-1 h-full bg-gradient-to-b from-[#ab8ff4] to-[#00daf3]"></div>
                <div className="w-10 h-10 rounded-full bg-[#1c1d22] border border-white/5 flex items-center justify-center shrink-0">
                    <span className="material-symbols-outlined text-[20px] text-white/70">sync</span>
                </div>
                <div>
                    <div className="text-sm font-bold text-white mb-1">Instant Sync</div>
                    <div className="text-[13px] text-white/50 leading-relaxed">
                        Changes are automatically saved and synced across all your connected devices including the Invikt mobile app.
                    </div>
                </div>
            </div>
        </div>
