    ...
    return (
        <section className="max-w-7xl mx-auto px-6 md:px-8 py-16 md:py-20 text-center relative mt-16 overflow-hidden md:overflow-visible">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass-panel border border-outline-variant/15 mb-8">
                ...
                <span className="text-xs uppercase tracking-widest font-label font-bold text-on-surface-variant">The Luminescent Architect of Careers</span>
            </div>
            
            <h1 className="font-headline text-4xl sm:text-5xl md:text-7xl font-extrabold tracking-tighter mb-6 bg-gradient-to-b from-on-surface to-on-surface-variant bg-clip-text text-transparent max-w-4xl mx-auto leading-tight px-2">
                Your AI Career Intelligence Platform
            </h1>
            
            <p className="text-base sm:text-lg md:text-xl text-on-surface-variant max-w-2xl mx-auto mb-12 leading-relaxed px-4">
                Turn your skills into opportunities with AI. Analyze resumes, bridge skill gaps, and navigate your future with architectural precision.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center w-full px-4">
                <button className="w-full sm:w-auto group relative px-8 py-4 bg-gradient-to-br from-primary to-primary-container text-on-primary font-bold rounded-xl shadow-2xl hover:scale-105 transition-all flex items-center justify-center gap-2 overflow-hidden">
                ...
                <button className="w-full sm:w-auto px-8 py-4 glass-panel border border-outline-variant/20 rounded-xl font-bold text-on-surface hover:bg-surface-bright/40 transition-all flex items-center justify-center gap-2">
                    Get Started Free
